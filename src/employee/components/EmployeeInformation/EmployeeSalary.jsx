      ...
      <table className="w-full text-sm text-left bg-white border-collapse">
        <tbody>
          <tr className="border-b border-red-400">
            <th
              scope="row"
              className="px-6 py-4 whitespace-nowrap bg-black text-white"
              onClick={toggleYear}
              style={{ cursor: "pointer" }}
            >
              <KeyboardArrowRightIcon
                className={isOpen ? "text-red-600 rotate-90" : "text-red-600"}
              />
          ...
          {isOpen &&
            Object.keys(salaries).map((month) => {
              ...
              const numberOfLeaveDays = salaries[month].numberOfLeaveDays;
              ...
              const taxableIncome =
                preTaxIncome - personalDeduction - dependentDeduction;

              return (
                <React.Fragment key={month}>
                  <tr
                    className={`border-b border-gray-200 ${
                      openMonth === parseInt(month) ? "bg-gray-100" : "hidden"
                    }`}
                  >
                  ...
                  <tr
                    className={`border-b border-gray-200 ${
                      openMonth === parseInt(month) ? "" : "hidden"
                    }`}
                  >
                    <td className="px-6 py-4 font-bold" colSpan="2">
                      Số ngày nghỉ:
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-right" colSpan="2">
                      - {socialInsurance.toLocaleString("en-US")}
                    </td>
                  </tr>
                  <tr
                    className={`border-b border-gray-200 ${
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-right" colSpan="2">
                      - {healthInsurance.toLocaleString("en-US")}
                    </td>
                  </tr>
                  <tr
                    className={`border-b border-gray-200 ${
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-right" colSpan="2">
                      - {unemploymentInsurance.toLocaleString("en-US")}
                    </td>
                  </tr>
                  <tr
                    className={`border-b border-gray-200 ${
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-right" colSpan="2">
                      {preTaxIncome.toLocaleString("en-US")}
                    </td>
                  </tr>
                  <tr
                    className={`border-b border-gray-200 ${
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-right" colSpan="2">
                      - {salaries[month].incomeTax.toLocaleString("en-US")}
                    </td>
                  </tr>
                  <tr
                    className={`border-b border-gray-200 ${
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-right" colSpan="2">
                      {salaries[month].netSalary.toLocaleString("en-US")}

    ...
    return (
        <footer className="mt-40 flex flex-col items-center text-center pt-14">
            ...
            <div className="container px-6 pt-6">
                <div className="mb-6">
                    <p>
                        An actual version of frontend build deployed to Vercel
                        and backend deployed to Render:
                        https://studywithnam.vercel.app
                    </p>
                </div>
                <div className="mb-6">
                    <p>
                        Teacher default account: Username: teacher@gmail.com ;
                        Password: teacher
                    </p>
                </div>
                <div>
                    <p className="text-red-800">
                        Note: If any request is not sent for a few minutes the
                        server will automatically suspend. It will start again
                        after 5 minutes since the first request.
                    </p>
                </div>
                <EmailRegister />
            </div>
